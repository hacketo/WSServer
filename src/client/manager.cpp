...
bool Manager::onHandshakeRecv(Client *client, protocol::http::header* handshake){ return true;}
bool Manager::onHandshakeSend(Client *client, protocol::http::header* handshake){ return true;}
